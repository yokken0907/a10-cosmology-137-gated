...
struct background
{
  ...
  int index_bg_gr_fac_D;     /**< growth factor D */
  int index_bg_gr_fac_f;     /**< growth rate f = dlnD/dlna */

/* 137プロジェクト：正規の表示用インデックス */
  int index_bg_chi;
  int index_bg_u_chi;
  int index_bg_rho_Y;
  int index_bg_rho_X;
  ...
  //@{
/* --- グループ1：宇宙の各成分 {B} --- */
  int index_bi_a;          /**< スケール因子 */
  int index_bi_rho_g;      /**< 放射（光子） */
  int index_bi_rho_b;      /**< バリオン */
  int index_bi_rho_cdm;    /**< 暗黒物質 */
  int index_bi_rho_ur;     /**< ニュートリノ */
